...
public:
    ...
    virtual void copy_image_to_image(CommandBufferHandle command_buffer_handle, TextureHandle src_texture_handle, TextureHandle dst_texture_handle, const ImageImageCopyInfo& info) = 0;

...
class REND_API RenderPass : public GPUResource, public RendObject
{
public:
    ...
    virtual void begin(CommandBuffer& command_buffer, const PerPassData& per_pass);
    virtual void next_subpass(CommandBuffer& command_buffer);
    virtual void end(CommandBuffer& command_buffer);

...
bool Image::_create_vk_image(VkImageType type, VkFormat format, VkExtent3D extent, uint32_t mip_levels, uint32_t array_layers, VkSampleCountFlagBits samples, VkImageTiling tiling, VkImageUsageFlags usage)
{
...
bool Image::_alloc_vk_memory(VkMemoryPropertyFlags memory_properties)
{
...
bool Image::_create_vk_image_view(VkFormat format, VkImageViewType view_type, VkImageAspectFlags aspects, uint32_t mip_levels, uint32_t array_layers)
{
...
bool Image::_create_vk_sampler(void)
{
...
void Image::transition(VkImageLayout final_layout)
{
